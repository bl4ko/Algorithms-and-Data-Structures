...
{
	Comparable element; // morajo podpirati vmesnik comparable; jih lahko primerjamo med seboj
	OrderedElement next;
...
// glavna POMANKLJIVOST
// ko iscemo vrednost nekega kljuca, se moramo sprehodit cez vse elemente ki so shranjeni v nasem seznamu
// in primerjat vrednost kljuca v seznamu s tistim kljucem ki ga iscemo
// O(n) casovna kompleksnost
